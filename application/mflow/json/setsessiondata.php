 ...
 *****************************************************/
    ...
    if (isset($_POST['params']['flow_record_count'])) {
        $_SESSION['MFLOW']['flow_record_count'] = intval($_POST['params']['flow_record_count']);
    ...
    if (isset($_POST['params']['aggregation_fields'])) {
        foreach ($_POST['params']['aggregation_fields'] as $key => $value) {
            $_SESSION['MFLOW']['aggregation_fields'][$key] = intval($value);
        }
    ...
    if (isset($_POST['params']['flow_display_filter'])) {
        $_SESSION['MFLOW']['flow_filter'] = $_POST['params']['flow_display_filter'];
    ...
    if (isset($_POST['params']['refresh'])) {
        ...
        $_SESSION['MFLOW']['refresh'] = intval($_POST['params']['refresh']);
    ...
    if (isset($_POST['params']['date1']) || isset($_POST['params']['hours1']) || isset($_POST['params']['minutes1'])) {
        if (nfcapd_files_exist($nfsen_profile_data_dir, $_SESSION['MFLOW']['nfsen_selected_sources'][0], $_POST['params']['date1'], $_POST['params']['hours1'], $_POST['params']['minutes1'])) {
            $_SESSION['MFLOW']['date1'] = $_POST['params']['date1'];
            $_SESSION['MFLOW']['hours1'] = $_POST['params']['hours1'];
            $_SESSION['MFLOW']['minutes1'] = $_POST['params']['minutes1'];
    ...
    if (isset($_POST['params']['date2']) || isset($_POST['params']['hours2']) || isset($_POST['params']['minutes2'])) {
        if (nfcapd_files_exist($nfsen_profile_data_dir, $_SESSION['MFLOW']['nfsen_selected_sources'][0], $_POST['params']['date2'], $_POST['params']['hours2'], $_POST['params']['minutes2'])) {
            $_SESSION['MFLOW']['date2'] = $_POST['params']['date2'];
            $_SESSION['MFLOW']['hours2'] = $_POST['params']['hours2'];
            $_SESSION['MFLOW']['minutes2'] = $_POST['params']['minutes2'];
    ...
    if (isset($_POST['params']['map_center'])) {
        $_SESSION['MFLOW']['map_center'] = $_POST['params']['map_center'];
        $result['session_data']['map_center'] = $_SESSION['MFLOW']['map_center'];
    }
    
    // Set map_center_wo_gray
    if (isset($_POST['params']['map_center_wo_gray'])) {
        $_SESSION['MFLOW']['map_center_wo_gray'] = $_POST['params']['map_center_wo_gray'];
        $result['session_data']['map_center_wo_gray'] = $_SESSION['MFLOW']['map_center_wo_gray'];
    }
    
    // Set zoom_level
    if (isset($_POST['params']['zoom_level'])) { // Google Maps zoom level
        $_SESSION['MFLOW']['zoom_level'] = floatval($_POST['params']['zoom_level']);
